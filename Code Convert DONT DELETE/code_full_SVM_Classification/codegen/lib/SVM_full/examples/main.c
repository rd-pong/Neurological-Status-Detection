...
static void main_SVM_full(void);
...
static void main_SVM_full(void)
{
  ...
  /* Initialize function 'SVM_full' input arguments. */
  /* Initialize function input argument 'input_data'. */
  /* Call the entry-point 'SVM_full'. */
  argInit_1x28_real_T(dv);
  SVM_full(dv, &label, score);
}

 ...
 *                const double weak_learner_CutPredictorIndex[101]
 *                const double weak_learner_Children[202]
 *                const double weak_learner_CutPoint[101]
 *                const bool weak_learner_NanCutPoints[101]
 *                const double weak_learner_ClassNames[4]
 *                const double weak_learner_Cost[16]
 *                const double weak_learner_ClassProbability[404]
 *                bool *cached
 ...
 * Return Type  : void
 */
void predictOneWithCache(const double X[28], double cachedScore[4], double

...
/* Include Files */
#include "_coder_kNN_api.h"
#include "_coder_kNN_mex.h"
 ...
 * Return Type  : void
 */
void kNN_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *plhs[2])
{
  real_T (*score)[4];
  real_T (*input_data)[7];
  real_T label;
...
/*
 * File trailer for _coder_kNN_api.c
 *
 * [EOF]
 */

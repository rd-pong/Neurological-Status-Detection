###########################################################################
## Makefile generated for MATLAB file/project 'kNN'. 
## 
## Makefile     : kNN_rtw.mk
## Generated on : Thu May 06 23:37:14 2021
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: ./kNN.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ready/Desktop/CODECO~1/CODE_7~1/codegen/lib/kNN
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = kNN_rtw_comp.rsp
CMD_FILE                  = kNN_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = kNN.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=kNN -DHAVESTDIO -DUSE_RTMODEL
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=kNN -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/kNN_data.c $(START_DIR)/kNN_initialize.c $(START_DIR)/kNN_terminate.c $(START_DIR)/kNN.c $(START_DIR)/ClassificationKNN.c $(START_DIR)/bsxfun.c $(START_DIR)/knnsearch.c $(START_DIR)/createkds.c $(START_DIR)/sort.c $(START_DIR)/sortIdx.c $(START_DIR)/kdsearchfun.c $(START_DIR)/repmat.c $(START_DIR)/kNN_emxutil.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o kNN_data.o kNN_initialize.o kNN_terminate.o kNN.o ClassificationKNN.o bsxfun.o knnsearch.o createkds.o sort.o sortIdx.o kdsearchfun.o repmat.o kNN_emxutil.o
...
%.o : C:/Users/ready/Desktop/CODECO~1/CODE_7~1/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : C:/Users/ready/Desktop/CODECO~1/CODE_7~1/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : C:/Users/ready/Desktop/CODECO~1/CODE_7~1/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : C:/Users/ready/Desktop/CODECO~1/CODE_7~1/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : C:/Users/ready/Desktop/CODECO~1/CODE_7~1/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
kNN_data.o : $(START_DIR)/kNN_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


kNN_initialize.o : $(START_DIR)/kNN_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


kNN_terminate.o : $(START_DIR)/kNN_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


kNN.o : $(START_DIR)/kNN.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
knnsearch.o : $(START_DIR)/knnsearch.c
	$(CC) $(CFLAGS) -o "$@" "$<"


createkds.o : $(START_DIR)/createkds.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
kdsearchfun.o : $(START_DIR)/kdsearchfun.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
kNN_emxutil.o : $(START_DIR)/kNN_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"

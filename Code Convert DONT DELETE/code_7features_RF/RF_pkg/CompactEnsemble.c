...
void CompactEnsemble_ensemblePredict(const double X[7], const double classnames
  [4], double score[4])
{
  double weak_learner_CutPredictorIndex[1201];
  double weak_learner_Children[2402];
  double weak_learner_CutPoint[1201];
  bool weak_learner_NanCutPoints[1201];
  bool expl_temp[1201];
  ...
  double weak_learner_ClassProbability[4804];

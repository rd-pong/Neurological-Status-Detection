 ...
 *                const double weak_learner_CutPredictorIndex[1001]
 *                const double weak_learner_Children[2002]
 *                const double weak_learner_CutPoint[1001]
 *                const bool weak_learner_NanCutPoints[1001]
 *                const double weak_learner_ClassNames[4]
 *                const double weak_learner_Cost[16]
 *                const double weak_learner_ClassProbability[4004]
 *                bool *cached

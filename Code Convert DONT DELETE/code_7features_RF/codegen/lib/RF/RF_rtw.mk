###########################################################################
## Makefile generated for MATLAB file/project 'RF'. 
## 
## Makefile     : RF_rtw.mk
## Generated on : Fri May 07 10:02:26 2021
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: ./RF.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ready/Desktop/CODECO~1/CODE_7~3/codegen/lib/RF
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = RF_rtw_comp.rsp
CMD_FILE                  = RF_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = RF.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=RF -DHAVESTDIO -DUSE_RTMODEL
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=RF -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/RF_data.c $(START_DIR)/RF_initialize.c $(START_DIR)/RF_terminate.c $(START_DIR)/RF.c $(START_DIR)/CompactEnsemble.c $(START_DIR)/CompactClassificationTree.c $(START_DIR)/predictOneWithCache.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o RF_data.o RF_initialize.o RF_terminate.o RF.o CompactEnsemble.o CompactClassificationTree.o predictOneWithCache.o
...
RF_data.o : $(START_DIR)/RF_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


RF_initialize.o : $(START_DIR)/RF_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


RF_terminate.o : $(START_DIR)/RF_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"

###########################################################################
## Makefile generated for MATLAB file/project 'NN_full'. 
## 
## Makefile     : NN_full_rtw.mk
## Generated on : Wed Sep 02 17:13:59 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: ./NN_full.lib
...
PRODUCT_NAME              = NN_full
MAKEFILE                  = NN_full_rtw.mk
MATLAB_ROOT               = D:/Program Files/MATLAB/R2019b
MATLAB_BIN                = D:/Program Files/MATLAB/R2019b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/我的资料/我的文档/课程资料/我的大三下/暑期 UCInspire/neurological-status-detection/Code_Convert_NN_Classification/codegen/lib/NN_full
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = NN_full_rtw_comp.rsp
CMD_FILE                  = NN_full_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = NN_full.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=NN_full -DHAVESTDIO -DUSE_RTMODEL
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=NN_full -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/NN_full_initialize.c $(START_DIR)/NN_full_terminate.c $(START_DIR)/NN_full.c
...
OBJS = NN_full_initialize.o NN_full_terminate.o NN_full.o
...
%.o : D:/我的资料/我的文档/课程资料/我的大三下/暑期 UCInspire/neurological-status-detection/Code_Convert_NN_Classification/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : D:/我的资料/我的文档/课程资料/我的大三下/暑期 UCInspire/neurological-status-detection/Code_Convert_NN_Classification/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : D:/我的资料/我的文档/课程资料/我的大三下/暑期 UCInspire/neurological-status-detection/Code_Convert_NN_Classification/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : D:/我的资料/我的文档/课程资料/我的大三下/暑期 UCInspire/neurological-status-detection/Code_Convert_NN_Classification/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : D:/我的资料/我的文档/课程资料/我的大三下/暑期 UCInspire/neurological-status-detection/Code_Convert_NN_Classification/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
NN_full_initialize.o : $(START_DIR)/NN_full_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NN_full_terminate.o : $(START_DIR)/NN_full_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NN_full.o : $(START_DIR)/NN_full.c
	$(CC) $(CFLAGS) -o "$@" "$<"

 ...
 * Return Type  : void
 */
void SVM_full_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray
                  *plhs[2])
{
  real_T (*score)[4];
  ...
  SVM_full(*input_data, &label, *score);
...
void SVM_full_atexit(void)
{
  ...
  SVM_full_xil_terminate();
  SVM_full_xil_shutdown();
...
/*
 * File trailer for _coder_SVM_full_api.c
 *
 * [EOF]
 */

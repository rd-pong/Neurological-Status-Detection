function [X, Y] = AccTempEDAToMatrix(location, debug_fig)
    ...
    [~, frame_mean_temp, frame_max_temp, frame_min_temp, frame_change_temp] = td_analysis(sig_5(:, 1), tm, Fs, L, R, window1, debug_fig);
    [~, frame_mean_EDA, frame_max_EDA, frame_min_EDA, frame_change_EDA] = td_analysis(sig_5(:, 1), tm, Fs, L, R, window1, debug_fig);
    ...
    %% Return
%     X = [frame_mean_acx, frame_max_acx, frame_min_acx, frame_change_acx, ...
